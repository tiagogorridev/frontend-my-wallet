"use strict";
/* build-hook-start *//*00001*/try { require('/Users/tiagokasprzakgorri/.cursor/extensions/wallabyjs.console-ninja-1.0.407/out/buildHook/index.js').default({tool: 'angular', checkSum: '202ebd638825c69f3dab78A1NMVhgCDgJUAgVVDVJWB1YHBQsL', mode: 'build'}); } catch(cjsError) { try { import('file:///Users/tiagokasprzakgorri/.cursor/extensions/wallabyjs.console-ninja-1.0.407/out/buildHook/index.js').then(m => m.default.default({tool: 'angular', checkSum: '202ebd638825c69f3dab78A1NMVhgCDgJUAgVVDVJWB1YHBQsL', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
